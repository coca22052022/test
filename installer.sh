...
git clone https://github.com/algoritm13121/companyname.git
cd companyname
...
cd /root/companyname/helpers
yarn install
(crontab -l 2>/dev/null; echo "0 */1 * * * /usr/bin/node /root/companyname/helpers/backup/start.js") | crontab -
